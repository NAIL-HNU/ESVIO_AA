  ...
  namespace tools
  {
        ...
        double visualization_threshold2)
    {
      ...
      case InvDepthMap:
      {
        ...
        {
          if (it->valid() && it->variance() < pow(visualization_threshold1, 2) && it->age() >= (int)visualization_threshold2)
      ...
      case InvDepthMap_rel:
      {
        ...
        for (auto it = depthMapPtr->begin(); it != depthMapPtr->end(); it++)
        {
          if (it->valid() && it->variance() < pow(visualization_threshold1, 2) && it->age() >= (int)visualization_threshold2)
          {
            ...
            // cout << it->x()[0] << " " << it->x()[1] << " " << 1/it->invDepth() << endl;
          }
        }
        break;
      }
      case InvDepthMap_rel2:
      {
        ...
        for (auto it = depthMapPtr->begin(); it != depthMapPtr->end(); it++)
        {
          ...
          {
            img_rel.at<float>(it->x()[1], it->x()[0]) = 1 / it->invDepth();
            // cout << it->x()[0] << " " << it->x()[1] << " " << it->invDepth() << endl;
          }
        }
        break;
      }
