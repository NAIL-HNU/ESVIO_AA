...
class esvo2_Mapping
{
  ...
  void rejectWithF(std::vector<EventMatchPair> &vEMP);
  ...
  message_filters::Subscriber<sensor_msgs::Image> AA_left_sub_, AA_right_sub_;
  message_filters::Subscriber<sensor_msgs::Image> last_now_left_sub_;
  ...
  typedef message_filters::sync_policies::ExactTime<sensor_msgs::Image, sensor_msgs::Image, sensor_msgs::Image> ExactSyncPolicy2;
  message_filters::Synchronizer<ExactSyncPolicy> TS_sync_, AA_sync_;
  message_filters::Synchronizer<ExactSyncPolicy2> TS_TOS2_sync_;
  ...
  StampedTimeSurfaceObs TS_obs_, Last_obs_;
